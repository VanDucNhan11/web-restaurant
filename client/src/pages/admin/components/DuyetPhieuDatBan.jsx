...
const DuyetPhieuDatBan = () => {
  ...
  const confirmCancel = async () => {
    try {
      const response = await fetch(`http://localhost:3000/api/v1/reservations/${selectedReservation}`, {
        method: 'DELETE',
      });
      if (!response.ok) {
  ...
  return (
    <div className="p-4 sm:p-8">
      <h2 className="text-3xl font-semibold mb-6 text-center title-1 title-font">Duyệt Phiếu Đặt Bàn</h2>
